...
$lista = $conn->query("select * from tbtipos"); // order, destaque, etc.)
...
<body class="fundofixo">
    ...
    <main class="container">
        <h2 class="breadcrumb alert-danger">TIPOS</h2>
        <table class="table table-hover table-condensed tb-opacidade">
            ...
            <?php  do {?><!-- iniocio estrutura repetição -->
                <tr>
                <td class="hidden"><?php echo $row['id_produto']; ?></td>
                        ...
                        <td>
                            ...
                            <td>
                                <a href="tipo_atualiza.php?sigla_tipo=<?php echo ($row['id_tipo']);?>" role="button " class="btn btn-warning btn-block btn-xs">
                            <span class="hidden-xs">ALTERAR</span>
                            <span class="glyphicon glyphicon-refresh"></span>
                            </a>
                            <button 
                                data-nome="<?php  echo $row['rotulo_tipo']?>"
                                data-id="<?php  echo $row['sigla_tipo']?>"
